// src/features/components/CategoryIconSelect.tsx
...
export function CategoryIconSelect({
    ...
    const renderSelectedValue = (selectedValue: string) => {
        ...
        const selectedOption = getCategoryIconOptionByValue(selectedValue);
    ...
    return (
        <FormControl fullWidth error={error} disabled={disabled}>
            <InputLabel id="category-icon-select-label">{label}</InputLabel>
